...
* Added opt-in trapezoidal and rhomboidal SHT truncation. Rhomboidal truncation retains modes with `l - m <= lmax - mmax`; for example, standard R42 uses `lmax=85` and `mmax=43`. Triangular truncation remains the default.
